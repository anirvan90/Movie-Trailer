...
<head>
    <meta charset="utf-8">
    <title>Anirvans Movie Library!</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">"Anirvans Movie Library"</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Show Info Modal -->
    ...
    <div class="col-md-6 extended-tile text-center"> 
        ...
        <div class="row text-center">
            <div class="col-md-4">
                 <a href="#"" data-toggle="modal" data-target=#{tag}><button type="button" class="btn btn-info btn-md">Info</button></a>                    
            </div>
